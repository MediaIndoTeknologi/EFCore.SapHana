...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Metadata.Conventions
{
    ...
    ///     or were configured to use a <see cref="SapHanaValueGenerationStrategy"/>.
    ///     It also configures properties as <see cref="ValueGenerated.OnAddOrUpdate"/> if they were configured as computed columns.
    /// </summary>
    public class SapHanaValueGenerationConvention : RelationalValueGenerationConvention
    {
        /// <summary>
        ///     Creates a new instance of <see cref="SapHanaValueGenerationConvention" />.
        /// </summary>
        /// <param name="dependencies"> Parameter object containing dependencies for this convention. </param>
        /// <param name="relationalDependencies">  Parameter object containing relational dependencies for this convention. </param>
        public SapHanaValueGenerationConvention(
        ...
        {
            if (name == SapHanaAnnotationNames.ValueGenerationStrategy)
            {
        ...
        public static new ValueGenerated? GetValueGenerated([NotNull] IReadOnlyProperty property, in StoreObjectIdentifier storeObject)
        {
            ...
            if (valueGenerationStrategy.HasValue)
            {
                ...
                {
                    case SapHanaValueGenerationStrategy.IdentityColumn:
                        return ValueGenerated.OnAdd;
                    case SapHanaValueGenerationStrategy.ComputedColumn:
