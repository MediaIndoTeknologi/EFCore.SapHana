...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// `UseJsonChangeTrackingOptions` extension method when calling `SapHanaDbContextOptionsBuilder.UseMicrosoftJson()`
    /// or `SapHanaDbContextOptionsBuilder.UseNewtonsoftJson()`, or for a specific model property when calling
    ...
    /// </summary>
    [Flags]
    public enum SapHanaCommonJsonChangeTrackingOptions
    {
        /// <summary>
