...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Internal
{
    ...
    public static class SapHanaStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("WonderKidEngine.EntityFrameworkCore.SapHana.Properties.SapHanaStrings", typeof(SapHanaStrings).GetTypeInfo().Assembly);
        ...
        ///     SAPHANA sequences cannot be used to generate values for the property '{property}' on entity type '{entityType}' because the property type is '{propertyType}'. Sequences can only be used with integer properties.
        ...
        ///     SAPHANA requires the table name to be specified for rename index operations. Specify table name in the call to MigrationBuilder.RenameIndex.
        ...
        ///     An exception has been raised that is likely due to a transient failure. Consider enabling transient error resiliency by adding 'EnableRetryOnFailure()' to the 'UseSapHana' call.
        ...
        ///     Translation of the '{declaringTypeName}.{methodName}' overload with a 'StringComparison' parameter is not supported by default. To opt-in to translations of methods with a 'StringComparison' parameter, call `{optionName}` on your SAPHANA specific 'DbContext' options. For general EF Core information about this error, see https://go.microsoft.com/fwlink/?linkid=2129535 for more information.
...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Internal
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static class SapHanaResources
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("WonderKidEngine.EntityFrameworkCore.SapHana.Properties.SapHanaStrings", typeof(SapHanaResources).GetTypeInfo().Assembly);
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SapHanaEventId.DecimalTypeDefaultWarning,
                        LogLevel.Warning,
                        "SapHanaEventId.DecimalTypeDefaultWarning",
        ...
        ///     The property '{property}' on entity type '{entityType}' is of type 'byte', but is set up to use a SAPHANA identity column. This requires that values starting at 255 and counting down will be used for temporary key values. A temporary key value is needed for every entity inserted in a single call to 'SaveChanges'. Care must be taken that these values do not collide with real key values.

        /// </summary>

        public static EventDefinition<string, string> LogByteIdentityColumn([NotNull] IDiagnosticsLogger logger)
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogByteIdentityColumn;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogByteIdentityColumn,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SapHanaEventId.ByteIdentityColumnWarning,
                        LogLevel.Warning,
                        "SapHanaEventId.ByteIdentityColumnWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema,
                    () => new EventDefinition<string>(
                        logger.Options,
                        SapHanaEventId.DefaultSchemaFound,
                        LogLevel.Debug,
                        "SapHanaEventId.DefaultSchemaFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundTypeAlias;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundTypeAlias,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SapHanaEventId.TypeAliasFound,
                        LogLevel.Debug,
                        "SapHanaEventId.TypeAliasFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundColumn;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundColumn,
                    () => new FallbackEventDefinition(
                        logger.Options,
                        SapHanaEventId.ColumnFound,
                        LogLevel.Debug,
                        "SapHanaEventId.ColumnFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundForeignKey;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundForeignKey,
                    () => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        SapHanaEventId.ForeignKeyFound,
                        LogLevel.Debug,
                        "SapHanaEventId.ForeignKeyFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet,
                    () => new EventDefinition<string, string, string>(
                        logger.Options,
                        SapHanaEventId.ForeignKeyReferencesMissingPrincipalTableWarning,
                        LogLevel.Warning,
                        "SapHanaEventId.ForeignKeyReferencesMissingPrincipalTableWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogMissingSchema;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogMissingSchema,
                    () => new EventDefinition<string>(
                        logger.Options,
                        SapHanaEventId.MissingSchemaWarning,
                        LogLevel.Warning,
                        "SapHanaEventId.MissingSchemaWarning",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogMissingTable;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogMissingTable,
                    () => new EventDefinition<string>(
                        logger.Options,
                        SapHanaEventId.MissingTableWarning,
                        LogLevel.Warning,
                        "SapHanaEventId.MissingTableWarning",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundSequence;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundSequence,
                    () => new FallbackEventDefinition(
                        logger.Options,
                        SapHanaEventId.SequenceFound,
                        LogLevel.Debug,
                        "SapHanaEventId.SequenceFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundTable;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundTable,
                    () => new EventDefinition<string>(
                        logger.Options,
                        SapHanaEventId.TableFound,
                        LogLevel.Debug,
                        "SapHanaEventId.TableFound",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundIndex;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundIndex,
                    () => new EventDefinition<string, string, bool>(
                        logger.Options,
                        SapHanaEventId.IndexFound,
                        LogLevel.Debug,
                        "SapHanaEventId.IndexFound",
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SapHanaEventId.PrimaryKeyFound,
                        LogLevel.Debug,
                        "SapHanaEventId.PrimaryKeyFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint,
                    () => new EventDefinition<string, string>(
                        logger.Options,
                        SapHanaEventId.UniqueConstraintFound,
                        LogLevel.Debug,
                        "SapHanaEventId.UniqueConstraintFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound,
                    () => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        SapHanaEventId.ForeignKeyPrincipalColumnMissingWarning,
                        LogLevel.Warning,
                        "SapHanaEventId.ForeignKeyPrincipalColumnMissingWarning",
                        level => LoggerMessage.Define<string, string, string, string>(
                            level,
        ...
        public static EventDefinition LogDefaultValueNotSupported([NotNull] IDiagnosticsLogger logger)
        {
            var definition = ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogDefaultValueNotSupported;
            if (definition == null)
            {
                definition = LazyInitializer.EnsureInitialized<EventDefinitionBase>(
                    ref ((Diagnostics.Internal.SapHanaLoggingDefinitions)logger.Definitions).LogDefaultValueNotSupported,
                    () => new EventDefinition(
                        logger.Options,
                        SapHanaEventId.DefaultValueNotSupportedWarning,
                        LogLevel.Warning,
                        "SapHanaEventId.DefaultValueNotSupportedWarning",
