...
{
    /// <summary>
    ///     SapHana specific extension methods for <see cref="DbContext.Database" />.
    /// </summary>
    public static class SapHanaDatabaseFacadeExtensions
    {
        /// <summary>
        ///     <para>
        ...
        public static bool IsSapHana([NotNull] this DatabaseFacade database)
