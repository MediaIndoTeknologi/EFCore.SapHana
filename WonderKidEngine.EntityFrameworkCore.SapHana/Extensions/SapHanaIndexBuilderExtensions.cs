...
{
    public static class SapHanaIndexBuilderExtensions
    {
        #region FullText

        // TODO: Remove/Hide for .NET 5.
        [Obsolete("This extension method is obsolete. Use IsFullText instead.")]
        public static IndexBuilder ForSapHanaIsFullText([NotNull] this IndexBuilder indexBuilder, bool fullText = true)
            => IsFullText(indexBuilder, fullText);

        // TODO: Remove/Hide for .NET 5.
        [Obsolete("This extension method is obsolete. Use IsFullText instead.")]
        public static IndexBuilder<TEntity> ForSapHanaIsFullText<TEntity>([NotNull] this IndexBuilder<TEntity> indexBuilder, bool fullText = true)
            => IsFullText(indexBuilder, fullText);
        ...
        public static IndexBuilder ForSapHanaIsSpatial([NotNull] this IndexBuilder indexBuilder, bool spatial = true)
            => IsSpatial(indexBuilder, spatial);

        // TODO: Remove/Hide for .NET 5.
        [Obsolete("This extension method is obsolete. Use IsSpatial instead.")]
        public static IndexBuilder<TEntity> ForSapHanaIsSpatial<TEntity>([NotNull] this IndexBuilder<TEntity> indexBuilder, bool spatial = true)
            => IsSpatial(indexBuilder, spatial);
