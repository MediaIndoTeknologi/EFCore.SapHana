...
{
    public static class SapHanaModelBuilderExtensions
    {
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(SapHanaAnnotationNames.CharSet, charSet, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(SapHanaAnnotationNames.CharSetDelegation, delegationModes, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(SapHanaAnnotationNames.CollationDelegation, delegationModes, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(SapHanaAnnotationNames.GuidCollation, collation, fromDataAnnotation);
        }
