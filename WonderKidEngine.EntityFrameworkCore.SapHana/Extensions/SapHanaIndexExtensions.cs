...
{
    /// <summary>
    ///     Extension methods for <see cref="IIndex" /> for SapHana-specific metadata.
    /// </summary>
    public static class SapHanaIndexExtensions
    {
        /// <summary>
        ...
        public static bool? IsFullText([NotNull] this IIndex index)
            => (bool?)index[SapHanaAnnotationNames.FullTextIndex];
        ...
        {
            index.SetOrRemoveAnnotation(SapHanaAnnotationNames.FullTextIndex, value, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetIsFullTextConfigurationSource([NotNull] this IConventionIndex property)
            => property.FindAnnotation(SapHanaAnnotationNames.FullTextIndex)?.GetConfigurationSource();
        ...
        [CanBeNull] public static string FullTextParser([NotNull] this IIndex index)
            => (string)index[SapHanaAnnotationNames.FullTextParser];
        ...
        {
            index.SetOrRemoveAnnotation(SapHanaAnnotationNames.FullTextParser, value, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetFullTextParserConfigurationSource([NotNull] this IConventionIndex property)
            => property.FindAnnotation(SapHanaAnnotationNames.FullTextParser)?.GetConfigurationSource();
        ...
        public static int[] PrefixLength([NotNull] this IIndex index)
            => (int[])index[SapHanaAnnotationNames.IndexPrefixLength];
        ...
        {
            index.SetOrRemoveAnnotation(SapHanaAnnotationNames.IndexPrefixLength, values, fromDataAnnotation);
        ...
        public static bool? IsSpatial([NotNull] this IIndex index)
            => (bool?)index[SapHanaAnnotationNames.SpatialIndex];
        ...
        {
            index.SetOrRemoveAnnotation(SapHanaAnnotationNames.SpatialIndex, value, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetIsSpatialConfigurationSource([NotNull] this IConventionIndex property)
            => property.FindAnnotation(SapHanaAnnotationNames.SpatialIndex)?.GetConfigurationSource();
    }
}
