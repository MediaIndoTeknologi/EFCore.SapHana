...
{
    /// <summary>
    /// Provides methods for supporting translation to SapHana JSON operators and functions.
    /// </summary>
    public static class SapHanaJsonDbFunctionsExtensions
    {
        /// <summary>
        ...
        /// </remarks>
        public static SapHanaJsonString AsJson([CanBeNull] this DbFunctions _, [NotNull] string value)
            => value;
        ...
        /// <remarks> For possible return values see: https://dev.SapHana.com/doc/refman/8.0/en/json-attribute-functions.html#function_json-type </remarks>
