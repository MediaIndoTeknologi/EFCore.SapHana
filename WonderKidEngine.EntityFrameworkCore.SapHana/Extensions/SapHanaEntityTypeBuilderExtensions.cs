...
{
    /// <summary>
    ///     SapHana specific extension methods for <see cref="EntityTypeBuilder" />.
    /// </summary>
    public static class SapHanaEntityTypeBuilderExtensions
    {
        ...
        /// <summary>
        /// Returns a value indicating whether the SapHana character set can be set on the table associated with this entity.
        /// </summary>
        /// <param name="entityTypeBuilder"> The builder for the entity type being configured. </param>
        /// <param name="charSet"> The name of the character set. </param>
        /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data annotation.</param>
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(SapHanaAnnotationNames.CharSet, charSet, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(SapHanaAnnotationNames.CharSetDelegation, delegationModes, fromDataAnnotation);
        }
        ...
        /// <summary>
        /// Sets the SapHana collation on the table associated with this entity. When you only specify the collation, SapHana implicitly sets
        ...
        /// <summary>
        /// Returns a value indicating whether the SapHana collation can be set on the table associated with this entity.
        /// </summary>
        /// <param name="entityTypeBuilder"> The builder for the entity type being configured. </param>
        /// <param name="collation"> The name of the collation. </param>
        /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data annotation.</param>
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(SapHanaAnnotationNames.CollationDelegation, delegationModes, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            var options = entityTypeBuilder.Metadata.GetTableOptions();
            UpdateTableOption(name, value, options);
            var optionsString = SapHanaEntityTypeExtensions.SerializeTableOptions(options);

            return entityTypeBuilder.CanSetAnnotation(SapHanaAnnotationNames.StoreOptions, optionsString, fromDataAnnotation);
        }
