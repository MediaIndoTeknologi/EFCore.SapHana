...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Storage.Internal
{
    ...
    /// </summary>
    public class SapHanaStringTypeMapping : SapHanaTypeMapping
    {
        ...
        public SapHanaStringTypeMapping(
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected SapHanaStringTypeMapping(
            RelationalTypeMappingParameters parameters,
            HanaDbType SapHanaDbType,
            ISapHanaOptions options,
            bool isUnquoted,
            bool forceToString)
            : base(parameters, SapHanaDbType)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SapHanaStringTypeMapping(parameters, SapHanaDbType, _options, IsUnquoted, _forceToString);

        public virtual RelationalTypeMapping Clone(bool? unquoted = null, bool? forceToString = null)
            => new SapHanaStringTypeMapping(Parameters, SapHanaDbType, _options, unquoted ?? IsUnquoted, forceToString ?? _forceToString);
