...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Storage.Internal
{
    ...
    /// </summary>
    public class SapHanaDateTimeOffsetTypeMapping : DateTimeOffsetTypeMapping, IDefaultValueCompatibilityAware
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public SapHanaDateTimeOffsetTypeMapping(
        ...
        /// </summary>
        protected SapHanaDateTimeOffsetTypeMapping(RelationalTypeMappingParameters parameters, bool isDefaultValueCompatible)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SapHanaDateTimeOffsetTypeMapping(parameters, _isDefaultValueCompatible);
        ...
        public virtual RelationalTypeMapping Clone(bool isDefaultValueCompatible = false)
            => new SapHanaDateTimeOffsetTypeMapping(Parameters, isDefaultValueCompatible);
