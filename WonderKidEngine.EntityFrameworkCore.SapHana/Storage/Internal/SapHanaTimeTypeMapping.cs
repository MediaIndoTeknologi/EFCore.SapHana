...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Storage.Internal
{
    ...
    /// </summary>
    public class SapHanaTimeTypeMapping : RelationalTypeMapping, IDefaultValueCompatibilityAware
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected SapHanaTimeTypeMapping(RelationalTypeMappingParameters parameters, bool isDefaultValueCompatible)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SapHanaTimeTypeMapping(parameters, _isDefaultValueCompatible);
        ...
        public virtual RelationalTypeMapping Clone(bool isDefaultValueCompatible = false)
            => new SapHanaTimeTypeMapping(Parameters, isDefaultValueCompatible);
        ...
        //       Check support in different SapHana/MariaDB versions first.
