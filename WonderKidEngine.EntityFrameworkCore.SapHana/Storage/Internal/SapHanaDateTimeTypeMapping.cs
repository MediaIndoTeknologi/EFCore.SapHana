...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Storage.Internal
{
    ...
    /// </summary>
    public class SapHanaDateTimeTypeMapping : DateTimeTypeMapping, IDefaultValueCompatibilityAware
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public SapHanaDateTimeTypeMapping(
        ...
        /// </summary>
        protected SapHanaDateTimeTypeMapping(RelationalTypeMappingParameters parameters, bool isDefaultValueCompatible)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SapHanaDateTimeTypeMapping(parameters, _isDefaultValueCompatible);
        ...
        public virtual RelationalTypeMapping Clone(bool isDefaultValueCompatible = false)
            => new SapHanaDateTimeTypeMapping(Parameters, isDefaultValueCompatible);
