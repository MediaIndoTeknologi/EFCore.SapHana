...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Storage.Internal
{
    ...
    /// </summary>
    public class SapHanaByteArrayTypeMapping : ByteArrayTypeMapping
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public SapHanaByteArrayTypeMapping(
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected SapHanaByteArrayTypeMapping(
            DbType type,
            string storeType,
            int? size,
            bool fixedLength)
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected SapHanaByteArrayTypeMapping(RelationalTypeMappingParameters parameters)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SapHanaByteArrayTypeMapping(parameters);
