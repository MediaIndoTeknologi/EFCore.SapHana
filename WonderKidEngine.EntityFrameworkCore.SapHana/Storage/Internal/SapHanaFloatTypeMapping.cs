...
{
    public class SapHanaFloatTypeMapping : FloatTypeMapping
    {
        /// <summary>
        ...
        /// </summary>
        public SapHanaFloatTypeMapping(
        ...
        /// </summary>
        protected SapHanaFloatTypeMapping(RelationalTypeMappingParameters parameters)
            : base(parameters)
        {
        }
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SapHanaFloatTypeMapping(parameters);
