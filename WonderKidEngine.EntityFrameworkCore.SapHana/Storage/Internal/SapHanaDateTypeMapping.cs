...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Storage.Internal
{
    ...
    ///     </para>
    /// </summary>
    public class SapHanaDateTypeMapping : RelationalTypeMapping, IDefaultValueCompatibilityAware
    {
        ...
        /// </summary>
        public SapHanaDateTypeMapping([NotNull] string storeType, Type clrType, bool isDefaultValueCompatible = false)
            : this(
        ...
        /// </summary>
        protected SapHanaDateTypeMapping(RelationalTypeMappingParameters parameters, bool isDefaultValueCompatible)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new SapHanaDateTypeMapping(parameters, _isDefaultValueCompatible);
        ...
        public virtual RelationalTypeMapping Clone(bool isDefaultValueCompatible = false)
            => new SapHanaDateTypeMapping(Parameters, isDefaultValueCompatible);
