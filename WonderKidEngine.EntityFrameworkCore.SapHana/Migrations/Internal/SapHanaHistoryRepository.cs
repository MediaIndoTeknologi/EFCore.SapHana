...
{
    public class SapHanaHistoryRepository : HistoryRepository
    {
        private const string MigrationsScript = nameof(MigrationsScript);

        private readonly SapHanaSqlGenerationHelper _sqlGenerationHelper;

        public SapHanaHistoryRepository([NotNull] HistoryRepositoryDependencies dependencies)
            : base(dependencies)
        {
            _sqlGenerationHelper = (SapHanaSqlGenerationHelper)dependencies.SqlGenerationHelper;
        }
