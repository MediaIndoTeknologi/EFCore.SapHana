...
namespace Microsoft.EntityFrameworkCore.Diagnostics
{
    ...
    /// <summary>
    ///     <para>
    ///         Event IDs for SapHana events that correspond to messages logged to an <see cref="ILogger" />
    ...
    ///     </para>
    /// </summary>
    public static class SapHanaEventId
    {
        ...
        /// <summary>
        ///     <para>
        ///         A byte property is set up to use a SapHana identity column.
        ///     </para>
        ///     <para>
        ///         This event is in the <see cref="DbLoggerCategory.Model.Validation" /> category.
        ///     </para>
