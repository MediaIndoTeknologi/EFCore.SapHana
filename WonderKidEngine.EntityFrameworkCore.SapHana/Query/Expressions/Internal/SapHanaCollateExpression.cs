...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Query.Expressions.Internal
{
    ...
    /// </summary>
    public class SapHanaCollateExpression : SqlExpression
    {
        private readonly SqlExpression _valueExpression;
        private readonly string _charset;
        private readonly string _collation;

        public SapHanaCollateExpression(
        ...
        protected override Expression Accept(ExpressionVisitor visitor)
            => visitor is SapHanaQuerySqlGenerator SapHanaQuerySqlGenerator // TODO: Move to VisitExtensions
                ? SapHanaQuerySqlGenerator.VisitSapHanaCollateExpression(this)
                : base.Accept(visitor);
        ...
        public virtual SapHanaCollateExpression Update(SqlExpression valueExpression)
            => valueExpression != _valueExpression &&
               valueExpression != null
                ? new SapHanaCollateExpression(valueExpression, _charset, _collation, TypeMapping)
                : this;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SapHanaCollateExpression)obj);
        }

        private bool Equals(SapHanaCollateExpression other)
