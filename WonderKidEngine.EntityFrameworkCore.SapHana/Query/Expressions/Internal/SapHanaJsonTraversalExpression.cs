...
{
    /// <summary>
    /// Represents a SapHana JSON operator traversing a JSON document with a path (i.e. x->y or x->>y)
    /// </summary>
    public class SapHanaJsonTraversalExpression : SqlExpression, IEquatable<SapHanaJsonTraversalExpression>
    {
        /// <summary>
        /// The JSON column.
        /// </summary>
        ...
        public SapHanaJsonTraversalExpression(
        ...
        protected SapHanaJsonTraversalExpression(
            [NotNull] SqlExpression expression,
        ...
        public virtual SapHanaJsonTraversalExpression Clone(bool returnsText, Type type, RelationalTypeMapping typeMapping)
            => new SapHanaJsonTraversalExpression(Expression, Path, returnsText, type, typeMapping);
        ...
        public virtual SapHanaJsonTraversalExpression Update(
            [NotNull] SqlExpression expression,
            [NotNull] IReadOnlyList<SqlExpression> path)
            => expression == Expression &&
        ...
        public virtual SapHanaJsonTraversalExpression Append([NotNull] SqlExpression pathComponent, Type returnType, RelationalTypeMapping typeMapping)
        {
            ...
            return new SapHanaJsonTraversalExpression(Expression, newPath, ReturnsText, returnType.UnwrapNullableType(), typeMapping);
        }

        public override bool Equals(object obj) => Equals(obj as SapHanaJsonTraversalExpression);

        public virtual bool Equals(SapHanaJsonTraversalExpression other)
