...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Query.Internal
{
    ...
    public class SapHanaQueryStringFactory : IRelationalQueryStringFactory
    {
        ...
        public SapHanaQueryStringFactory([NotNull] IRelationalTypeMappingSource typeMapper)
        {
        ...
        {
            // SapHana does not support user variables in LIMIT statements.
            // (It does however support parameters in LIMIT statements since 2010. See https://bugs.SapHana.com/bug.php?id=11918)
            //
            ...
            var parser = new SapHanaCommandParser(command.CommandText);
