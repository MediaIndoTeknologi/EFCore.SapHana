...
{
    public class SapHanaCommandParser
    {
        public virtual string SqlFragment { get; }
        public virtual char[] States { get; }

        public SapHanaCommandParser(string sqlFragment)
        {
        ...
        protected virtual void Parse()
        {
            ...
            // State machine to parse SapHana SQL.
                ...
                if (state == '-')
                {
                    if (lastChar == '-')
                    {
                            ...
                            secondTolastChar == '\0')
                        {
                            ...
                            // In SapHana, a line comment starts with two dashes and a whitespace.
                            secondTolastChar = '-';
                        }
