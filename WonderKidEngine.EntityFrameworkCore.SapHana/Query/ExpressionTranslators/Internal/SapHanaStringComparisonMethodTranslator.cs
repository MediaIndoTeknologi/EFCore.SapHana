...
{
    public class SapHanaStringComparisonMethodTranslator : IMethodCallTranslator
    {
        ...
        public SapHanaStringComparisonMethodTranslator(ISqlExpressionFactory sqlExpressionFactory, ISapHanaOptions options)
        {
            ...
            bool startsWith)
        {
            ...
            if (prefixSuffix is SqlConstantExpression constantPrefixSuffixExpression)
            {
                ...
                // TODO: EF Core 5
                // https://github.com/PomeloFoundation/WonderKidEngine.EntityFrameworkCore.SapHana/issues/996#issuecomment-607876040
            ...
            // See https://github.com/PomeloFoundation/WonderKidEngine.EntityFrameworkCore.SapHana/issues/996#issuecomment-607733553
        ...
        private static bool TryGetExpressionValue<T>(SqlExpression expression, out T value)
        {
            if (expression.Type != typeof(T))
            {
                throw new ArgumentException(
                    SapHanaStrings.ExpressionTypeMismatch,
                    nameof(expression)
                );
            }
