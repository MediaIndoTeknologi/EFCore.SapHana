...
namespace WonderKidEngine.EntityFrameworkCore.SapHana.Query.ExpressionVisitors.Internal
{
    ...
    /// See https://github.com/PomeloFoundation/WonderKidEngine.EntityFrameworkCore.SapHana/issues/1104
    /// </summary>
    public class SapHanaBoolOptimizingExpressionVisitor : SqlExpressionVisitor
    {
        private bool _optimize;
        private readonly ISqlExpressionFactory _sqlExpressionFactory;

        public SapHanaBoolOptimizingExpressionVisitor(
        ...
        private Expression ApplyConversion(SqlExpression sqlExpression, bool condition)
        {
            if (_optimize &&
                ...
                sqlExpression.TypeMapping is SapHanaBoolTypeMapping &&
        ...
        protected override Expression VisitSqlBinary(SqlBinaryExpression sqlBinaryExpression)
        {
            ...
            //       See `GearsOfWarQuerySapHanaTest`.
            ...
            if (_optimize &&
                ...
                columnExpression.TypeMapping is SapHanaBoolTypeMapping &&
                columnExpression.Type == typeof(bool) &&
                sqlConstantExpression.TypeMapping is SapHanaBoolTypeMapping &&
        ...
        protected override Expression VisitSqlUnary(SqlUnaryExpression sqlUnaryExpression)
        {
            ...
            // Translating to "NOT(`boolColumn`)" would not use indices in SapHana 5.7.
