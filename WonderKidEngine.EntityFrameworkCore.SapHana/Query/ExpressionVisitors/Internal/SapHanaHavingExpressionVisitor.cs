...
{
    public class SapHanaHavingExpressionVisitor : ExpressionVisitor
    {
        private readonly SapHanaSqlExpressionFactory _sqlExpressionFactory;
        private SapHanaContainsAggregateFunctionExpressionVisitor _containsAggregateFunctionExpressionVisitor;

        public SapHanaHavingExpressionVisitor(SapHanaSqlExpressionFactory sqlExpressionFactory)
        {
        ...
        {
            // SapHana & MariaDB currently do not support complex expressions in HAVING clauses (e.g. function calls).
            // Instead, they want you to reference SELECT aliases for those expressions in the HAVING clause.
            // See https://bugs.SapHana.com/bug.php?id=103961
            ...
            {
                _containsAggregateFunctionExpressionVisitor ??= new SapHanaContainsAggregateFunctionExpressionVisitor();
        ...
        /// </summary>
        private sealed class SapHanaContainsAggregateFunctionExpressionVisitor : ExpressionVisitor
        {
            // See https://dev.SapHana.com/doc/refman/8.0/en/aggregate-functions.html
